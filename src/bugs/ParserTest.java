...
public class ParserTest {
    ...
    public void testIsProgram() {
	    ...
	    assertTrue(parser.isProgram());
	   	assertStackTopEquals(tree("program",
	    							tree("Allbugs", 
	    								tree("list", 
	    									tree("var","beebui","beebuku","beebudu")),
	    									tree( "list",
	    									   tree("function","foo", tree("var","a","b","c"), "block"))),
	    									tree("list", tree("Bug","beebu",tree("list", tree("var", "beebui", "beebuku", "beebudu")),
	    											tree("initially","block"), tree("block",tree("moveto","8.0","7.0")),"list")))); //));
    ...
    public void testIsBugDefinition(){
	    ...
	    assertStackTopEquals(tree("Bug","beebu",
					                  tree("list",
					                      tree("var","beebui")), 
										     "initially",
										     tree("block", tree("moveto","8.0","7.0")),"list"));
    ...
    public void testIsInitializationBlock(){
    	...
    	assertStackTopEquals(tree("initially", tree("block", tree("move", "a"))));
    	
    	use(" initially { \n  } \n");
    	assertTrue(parser.isInitializationBlock());
    	assertStackTopEquals(tree("initially", "block"));
    	
  	  try {
          use(" initially { Allbugs \n move a \n } \n");
    ...
    public void testIsCommand(){
    	...
    	assertStackTopEquals(tree("turnto","alpha"));
    	followedBy(parser,"$");
    	
      	use(" line alpha, beta, gamma, delta \n $");
    	assertTrue(parser.isCommand());
    	assertStackTopEquals(tree("line","alpha", "beta", "gamma", "delta"));
  
    	use(" do this ( x,y,z,d) \n ");
    	assertTrue(parser.isStatement());
    	assertStackTopEquals(tree("call", "this", tree("var","x","y","z","d")));
    }
    ...
    public void testIsMoveAction(){
    	...
    	assertStackTopEquals(tree("move","a"));
    ...
    public void testIsMoveToAction(){
    	...
    	assertStackTopEquals(tree("moveto","a","b"));
    	followedBy(parser, "alpha");
    }
    ...
    public void testIsTurnAction(){
    	...
    	assertStackTopEquals(tree("turn","a"));
    ...
    public void testIsTurnToAction(){
    	...
    	assertStackTopEquals(tree("turnto", "a"));
    ...
    public void testIsLineAction(){
     	use(" line this, that, them, us \n turnto a \n $");
    	assertTrue(parser.isLineAction());
    	assertStackTopEquals(tree("line","this", "that", "them", "us"));
 //   	followedBy(parser, "turnto");
    	assertTrue(parser.isTurnToAction());
      	assertStackTopEquals(tree("turnto", "a"));
      	followedBy(parser, "$");
      	
      	 try {
             use(" line this, that, them, us, we \n turnto a \n $");
    ...
    public void testIsAssignmentStatement(){
    	use(" america  =  president \n");
    	assertTrue(parser.isAssignmentStatement());
    	assertStackTopEquals(tree("assign","america","president"));
    	
    	use(" a  =  44 + b \n");
    	assertTrue(parser.isAssignmentStatement());
    	assertStackTopEquals(tree("assign","a",tree("+","44.0","b")));
    ...
    public void testIsLoopStatement(){
    	...
    	assertStackTopEquals(tree("loop", tree("block",tree("assign","america","president"))));
    ...
    public void testIsExitIfStatement(){
    	...
    	assertStackTopEquals(tree("exit","this"));
    ...
    public void testIsSwitchStatement(){
    	...
    	assertStackTopEquals(tree("switch",
    							tree("case", "a", tree("block", tree("move", "1.0")))));
    ...
    public void testIsReturnStatement(){
    	...
    	assertStackTopEquals(tree("return","a"));
    	
    	 use("return x <= y\n");
         assertTrue(parser.isReturnStatement());
         assertStackTopEquals(tree("return",tree("<=", "x" , "y")));
    }
    ...
    public void testIsDoStatement(){
    	use(" do that (a,b,c) \n");
    	assertTrue(parser.isDoStatement());
    	assertStackTopEquals(tree("call","that",tree("var","a","b","c")));
    	
    	use(" do that  \n");
    	assertTrue(parser.isDoStatement());
    	assertStackTopEquals(tree("call","that"));
    ...
    public void testIsBlock(){
    	...
    	assertStackTopEquals(tree("block", tree("call", "that", tree("var","a","b","c"))));
    ...
    public void testIsFunctionDefinition(){
    	use("define foo using a,b,c { \n } \n ");
    	assertTrue(parser.isFunctionDefinition());
    	assertStackTopEquals(tree("function", "foo", tree("var","a","b","c"), "block"));
    ...
    public void testIsFunctionCall(){
    	...
    	assertStackTopEquals(tree("call", "foo", tree("var","a","b","c")));
    	
       	use("foo ()");
    	assertTrue(parser.isFunctionCall());
    	assertStackTopEquals(tree("call", "foo", "var"));
    }
